...
<body onload="init()">
<form action="ChangeInfo.jsp" method="post" onsubmit="return CheckSubmit()">
		<%
		...
		<div class="regist">
			<div class="regist_center">
				...
				<div class="regist_main center">
					<div class="username"><span style="color: red">*&nbsp;</span>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称:&nbsp;&nbsp;<input class="shurukuang" type="text" onblur="CheckName()" name="name" id="name" value="<%=user.getUname() %>"/><span id="name1">请输入6位以上字符</span></div>
					<div class="username"><span style="color: red">*&nbsp;</span>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄:&nbsp;&nbsp;<input class="shurukuang" type="text" onblur="CheckAge()" name="age" id="age" value="<%=user.getAge()%>"/><span id="age1">请输入1-100岁位以内的年龄</span></div>
					<div class="username"><span style="color: red">*&nbsp;</span>手&nbsp;&nbsp;机&nbsp;&nbsp;号:&nbsp;&nbsp;<input class="shurukuang" type="text" name="phone" value="<%=user.getPhone()%>"/><span>填写下手机号吧，方便我们联系您！</span></div>
				...
				<div class="regist_submit">
					<input class="submit" type="submit" name="register" value="更改信息" >
				</div>
				<div class="regist_submit">
