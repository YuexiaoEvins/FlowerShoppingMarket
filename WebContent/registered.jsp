...
function CheckName()
{
	...
	if(strText==null||strText=="")
	{
		name1.innerHTML="昵称不能为空！";
		return false;
	}else {
		name1.innerHTML=null;
		return true;
	}	
}
...
function CheckAge()
{
	var strText = document.getElementById("age").value;
	var age1 = document.getElementById("age1");
	
	age1.style.color="red";
	if(strText==null||strText==""||(parseInt(strText)<=0 || parseInt(strText)>=149))
	{
		age1.innerHTML="请输入合法年龄！范围为1-149";
		return false;
	}else {
		age1.innerHTML=null;
		return true;
...
function CheckSubmit(){
	if (CheckAge()&&CheckId()&&CheckName()&&CheckPassword()&&CheckRefill()) {
		return true;
	}
	else {
		alert("信息不完全，请填写完！");
...
<body onload="init()">
	<h2>新用户注册</h2>
	<form action="registeredSucceed.jsp" method="post" onsubmit="return CheckSubmit()">
		<div class="regist">
			<div class="regist_center">
				...
				<div class="regist_main center">
					<div class="username"><span style="color: red">*&nbsp;</span>用&nbsp;&nbsp;户&nbsp;&nbsp;名:&nbsp;&nbsp;<input class="shurukuang" type="text" onblur="CheckId()" id="id" name="id" placeholder="请输入你的用户名"/><span id="id1">请不要输入汉字</span></div>
					<div class="username"><span style="color: red">*&nbsp;</span>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称:&nbsp;&nbsp;<input class="shurukuang" type="text" onblur="CheckName()" name="name" id="name" placeholder="请输入你的昵称"/><span id="name1">请输入6位以上字符</span></div>
					...
					<div class="username"><span style="color: red">*&nbsp;</span>年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄:&nbsp;&nbsp;<input class="shurukuang" type="text" onblur="CheckAge()" name="age" id="age" placeholder="请输入你的年龄"/><span id="age1">请输入1-100岁位以内的年龄</span></div>
					<div class="username"><span style="color: red">*&nbsp;</span>手&nbsp;&nbsp;机&nbsp;&nbsp;号:&nbsp;&nbsp;<input class="shurukuang" type="text" name="phone" placeholder="请填写正确的手机号"/><span>填写下手机号吧，方便我们联系您！</span></div>
					<div class="username"><span style="color: red">*&nbsp;</span>所&nbsp;&nbsp;在&nbsp;&nbsp;地:&nbsp;&nbsp;				
					<select style="width:110px;"name="province" id="param_province" onchange="provincechange(this.selectedIndex)"><option>请选择省份</option></select>
					<select style="width:110px;"name="city" id="param_city"><option>请选择城市</option></select></div>
					<div class="username"><span style="color: red">*&nbsp;</span>住&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:&nbsp;&nbsp;<input class="shurukuang" type="text" name="address" placeholder="请填写正确的住址"/><span>填写下住址吧，方便我们将货物送达！</span></div>
				</div>
